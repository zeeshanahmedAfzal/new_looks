    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          child: ATButtonV3(
                            ...
                            onTap: () async {
                              ...
                              if (controller.enableButton.value == true) {
                                ...
                                controller.register(email: controller.email.value, password: controller.password.value, firstName: controller.firstName.value,
                                lastName: controller.lastName.value
                                );
                                print(values);
                              }
                      ...
                      GestureDetector(
                        onTap: (){
                          controller.signUpWithGoogle("Sign up");
                        },
                        child: Container(
          ...
          Obx(()=>
              Visibility(
                  visible: controller.isLoggingWithGoogle.isTrue,
                  child: Stack(
                    children: [
                      Container(
                      ...
                      Center(
                        child: Container(
                          ...
                          height: 100,
                          decoration: BoxDecoration(
                            color: Colors.black, // Container background
                            borderRadius: BorderRadius.circular(10),
                          ),
                          child: Center(
